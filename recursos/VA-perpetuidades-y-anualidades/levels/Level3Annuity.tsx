    ...
    <div className="flex flex-col lg:flex-row h-full">
      ...
      <div className="flex-1 p-8 flex flex-col">
        ...
        <div className="flex-1 min-h-[300px] bg-slate-50 rounded-xl border border-slate-100 p-4">
          <h3 className="text-center text-slate-400 font-semibold mb-4 uppercase text-xs tracking-widest">
            Flujos de la Anualidad (Fin en t={n})
          </h3>
          <ResponsiveContainer width="100%" height="90%">
            <BarChart data={data} margin={{ top: 10, right: 30, left: 0, bottom: 20 }}>
              <CartesianGrid strokeDasharray="3 3" vertical={false} stroke="#e2e8f0" />
              <XAxis dataKey="period" stroke="#94a3b8" fontSize={12} tickMargin={10} interval={0} />
