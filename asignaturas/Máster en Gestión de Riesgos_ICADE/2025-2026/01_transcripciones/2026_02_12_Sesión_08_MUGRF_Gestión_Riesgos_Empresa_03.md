...
- Su valor deriva de un acuerdo contractual.
    

Ejemplos:

- Bono → contrato de deuda.
    
- Acción → contrato de propiedad.
    
- Dinero → contrato implícito con el Banco Central.
    
- Derivado → contrato sobre contrato.
...
- Agencias de valores (broker)
    
- Sociedades de valores (trader)
...
- Broker → ejecuta para terceros.
    
- Sociedad de valores → puede operar por cuenta propia.
...
- Canalizar mercados oficiales.
    
- Permitir anotaciones en cuenta.
    
- Acceso a instrumentos regulados.
...
- Conectan ahorro y necesidad.
    
- Funcionan en Internet.
    
- Operan sin supervisión tradicional.
    
- Usan smart contracts (programas automáticos).
...
- Los modelos deben ser aprobados por el supervisor.
    
- No basta con programar.
    
- Hay que entender la lógica económica.
...
- Finanzas = gestión del futuro incierto
    
- Instrumentos = contratos
    
- Sistema financiero = arquitectura regulada
    
- Supervisores = policía del sistema
    
- Modelos = herramientas, no oráculos
...
Trauma y perturbador, me has, me has traumado, dice, y además me has traumado y luego y luego me renta, me renta, que me encanta lo de ir me renta, me encanta porque digo, *****, estamos viniendo. Bueno, a ver, seguimos, o sea.  
...
Hemos hablado de José Luis Caballa. No, yo veo otra cosa. ¿Lo miraste y luego? Es un creo que es subnormal. ¿Continuaste? También dijiste que es ********** prácticamente. No, no, no. Ahí está escrito, ¿eh? No, normalmente está en un punto en medio.  
