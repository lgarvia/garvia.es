# 🧾 **Informe de Sesión – 11 de noviembre de 2025**
...
- La **deuda pública** es _una magnitud de fondo_ (el stock acumulado).
    
- El **déficit público** es _una magnitud de flujo_ (la variación anual de ese fondo).
    
- El **PIB** es _un flujo_, no un fondo.  
    Por tanto, **comparar deuda con PIB tiene sentido**, pero **comparar gasto con deuda o PIB con capitalización bursátil no**.
...
- **El Estado** es la estructura estable que organiza la convivencia: _educación, sanidad, justicia, seguridad, redistribución_.
    
- **El Gobierno** es quien _ejerce la política_ dentro del Estado.
    
- El **objeto social** de una empresa está en sus estatutos (lo que puede y debe hacer).
    
- El **objeto social del Estado** es el _bienestar común_.
...
- La concede el **Banco Central nacional** (en la UE, dentro del sistema del **Mecanismo Único de Supervisión – MUS**).
    
- Permite **captar depósitos del público** y **prestar dinero**.
    
- Es el equivalente a una licencia de taxi: **te autoriza a ofrecer un servicio público bajo regulación y supervisión.**
    

### Licencia de dinero electrónico

- Autorización distinta: permite recibir dinero de clientes y emitir un equivalente digital.
    
- **Ejemplo:** _Google Pay_ o _Apple Pay_ → pueden custodiar fondos, pero **no pueden conceder créditos ni pagar intereses.**
    
- Se concede por un Banco Central nacional (en la UE, pasaporte único europeo).
...
- **2008 – Crisis Subprime:** quiebra de Lehman Brothers → Reserva Federal duplica la base monetaria.
    
- **2010–2012 – Crisis de deuda europea:** Grecia, España, Italia → BCE lanza LTRO y OMT.
    
- **2020 – COVID-19:** cheques directos en EE. UU. → salto en M2 → inflación de demanda.
    
- **2022 – Guerra de Ucrania:** encarecimiento de energía → inflación de oferta en Europa.
    
- **2023 – SVB:** subida de tipos + bonos de larga duración → pérdidas latentes → rescate silencioso de banca regional.
...
- En EE. UU. las ayudas COVID se realizaron **directamente a hogares** → aumentó M2 → **inflación de demanda.**
    
- En la UE las ayudas fueron **canalizadas vía Gobiernos y bancos** → afectó a M0 → **inflación más moderada y posterior.**
...
- **Flujo/Fondo:** “El déficit llena el cubo de la deuda.”
    
- **Licencia bancaria = licencia de taxi.**
    
- **Estandarización = liquidez:** lo estándar facilita intercambios (como la palabra “taxi” en todos los idiomas).
    
- **Política monetaria:** “Controlar el dinero para controlar la inflación.”
    
- **Gestión del riesgo:** “Equilibrar activos y pasivos: duración de activos = duración de pasivos.”
    
- **Economía emocional:** sin componente emocional no hay aprendizaje durable.
...
- **Diapositivas:** “Política monetaria y Banco Central”
    
- **Excel:** simulador de agregados monetarios y multiplicador
    
- **Lecturas recomendadas:**
    
    - Paul Krugman, _The Return of Depression Economics_
        
    - BCE, _The Monetary Policy Strategy_ (2023)
        
    - BIS, _Money and Credit Aggregates after QE_ (2022)
...
> ¿Estamos ante una _uberización del dinero_?
...
- Analizar la forma y significado de la curva de tipos.
    
- Diferenciar entre curva soberana y curva swap.
    
- Introducir el concepto de **inmunización de carteras**.
...
Mejor vas a ver la foto general y al final esto de lo que va es de constantemente estar subiendo y bajando, no me pasa Diego y hablo sin tener ni idea que cuando entrenas la sentadilla luego, *****, Rubén, perdóname, Rubén Rubén.  
...
¿Sí, señora Meyer Meyer, Meyer, Meyer, Meyer Meyer, Meyer Meyer, Andrés Meyer Meyen de de **** Madre no a ver que es eso, es sensibilidad al tipo de interés?  
...
¿Os ***** cómo se llama que se me olvida siempre su nombre, la chica que os iba a contar, Josefina, Josefina o Josefina, habló del del activo y del pasivo, el activo en principio, qué es? Estoy simplificando mucho el activo. En principio, qué es. Flujos de.  
...
6.  
¿Que si yo tengo que pagar algo en 5 años?  
...
¿Ah, no me he pasado?  
7.  
Septiembre de 2008 es cero 9 y esto.  
¿Cero 9, vale?  
...
8.  
¿Qué hace la Reserva Federal? Multiplica por dos la base monetaria.  
...
¿Que se fueron a la ****** y qué tuvo que que hacer la Reserva Federal para salvarle la cara a los bancos?  
