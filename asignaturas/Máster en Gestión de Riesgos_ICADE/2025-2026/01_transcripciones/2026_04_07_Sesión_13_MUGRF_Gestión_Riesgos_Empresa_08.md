# **Informe de sesión: Riesgo País y Riesgo Geopolítico**
...
## **2. Qué es realmente el riesgo país**
...
## **3. Realidad del impago soberano**
...
## **4. Clave conceptual: voluntad vs capacidad de pago**
...
## **5. Cómo se analiza el riesgo país (framework real)**

El análisis es bastante estándar entre bancos, agencias y organismos.

### 5.1. Histórico de impagos
...
### 5.5. Sector externo (CRÍTICO en banca)
...
## **6. Regulación y provisiones (clave práctica en España)**
...
## **7. Qué hace un equipo de riesgo país en banca**

Funciones principales:

1. Asignar ratings internos
    
2. Establecer límites de exposición por país
    
3. Analizar operaciones relevantes
    
4. Monitorizar riesgos continuamente
    
5. Reportar al regulador
...
## **8. El cambio estructural: auge del riesgo geopolítico**
...
## **9. Por qué el riesgo geopolítico es diferente**
...
## **10. Cómo se analiza la geopolítica en la práctica**
...
- Índice de la Federal Reserve basado en prensa
...
## **11. Metodología real de impacto (lo más importante de la sesión)**

Cadena de transmisión del riesgo:

**Geopolítica → Variables macro → Modelos → Impacto financiero**

1. Se construyen escenarios
    
2. Se estiman impactos en:
...
## **12. Caso práctico: crisis energética actual**
...
- Revolución iraní (1979): ~5,6 millones
    

---

## **13. Factores de impacto por país**
...
## **16. Cómo reaccionan los bancos ante una crisis**

Proceso real descrito:

1. Medir exposición total
    
2. Analizar ratings
    
3. Identificar sectores vulnerables
...
## **17. Ideas estratégicas clave de la sesión**

### 1. El riesgo país es multidimensional

No es solo deuda → es política, cultura y estructura

### 2. La geopolítica manda
...
### 4. Los shocks son no lineales

Pequeños cambios → grandes impactos

### 5. El verdadero riesgo es indirecto

Energía → inflación → tipos → mora

---

## **18. Reflexión final (muy en tu línea, Luis)**
