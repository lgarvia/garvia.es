---
titulo: "IEB – Deontología Profesional – Sesión 1"
fecha: 2026-09-07
curso: "Deontología Profesional (Fall 2026)"
sesion: 1
...
- reflexión ética a partir de situaciones cotidianas;
    
- introducción a la diferencia entre **lo posible, lo legal y lo éticamente correcto**;
    
- explicación de la importancia del **cuidado**;
    
- presentación de la metodología docente;
    
- reflexión sobre el aprendizaje y el pensamiento crítico;
    
- incorporación de herramientas digitales e inteligencia artificial;
    
- consejos sobre la universidad y el futuro profesional;
    
- intervención de antiguos alumnos;
    
- y una primera aproximación al papel de la información y de la tecnología en la formación universitaria.
...
- para distribuir posteriormente el contenido sin autorización;
    
- para utilizar la información contra alguien;
    
- para conservar una copia privada;
    
- o para transcribir una clase y facilitar el aprendizaje de los alumnos.
...
- qué responsabilidades aparecen cuando actuamos profesionalmente;
    
- qué hábitos construyen nuestra conducta;
    
- y cómo diferenciar entre lo permitido y lo correcto.
...
- detectar necesidades diferentes;
    
- ayudar cuando es necesario;
    
- exigir cuando es necesario;
    
- introducir a otras personas;
    
- facilitar oportunidades;
    
- o tratar de forma diferente situaciones que son diferentes.
...
- o especialmente cómoda ante la exposición pública
...
- y podemos corregir nuestra conducta.
...
- un estímulo se asocia repetidamente a una respuesta;
    
- finalmente, la respuesta aparece incluso cuando desaparece el estímulo original.
...
- y la responsabilidad de quien las utiliza.
...
- o la utilización automática de herramientas sin reflexión.
...
- que había comenzado un nuevo curso;
    
- que se trataba de una nueva generación de alumnos;
    
- y cuál era la situación concreta.
...
- quiénes son determinados profesores;
    
- qué herramientas existen;
    
- cómo funciona el mundo profesional.
...
- cómo interpreta las fuentes;
    
- y si la respuesta coincide realmente con el contenido original.
...
- diferentes áreas del sector financiero.
...
- sistemas de incentivos diferentes.
...
- se construyen acumulativamente;
    
- y resulta más difícil recuperar posteriormente conceptos que no se han trabajado desde el comienzo.
...
- escuchar argumentos contrarios;
...
- explicar cómo funciona la asignatura;
    
- y ofrecer consejos desde la perspectiva de quienes ya habían pasado por ella.
...
- una persona que entra en clase;
...
- no reconocemos el error;
    
- lo escondemos;
    
- culpamos a otros;
    
- o construimos nuevos errores para proteger el primero.
...
- se pueda responder mal;
    
- se pueda cambiar de opinión;
    
- se pueda participar;
    
- y se pueda reconocer que algo no se entiende.
...
- ¿qué tipo de persona estoy siendo al actuar así?
...
### 2. Lo legal y lo ético son planos relacionados, pero diferentes.
...
- qué significa proporcionar contexto;
    
- y cómo interactuar adecuadamente con sistemas de inteligencia artificial.
...
#  Transcripción
7 de septiembre de 2026, 10:36a.m.
1 h 55 min 22 s
 Hoy es el primer día que os estoy dando clase. ¿Alguien sabe? Ya estoy, o sea, me grabo solo a mí mismo.  
Si alguien.  
...
No.  
Ahora tengo.  
Sí, lo han dicho, claro, pues *****, me los anda estropeado para los de primeros años, están atendiendo todos.  
